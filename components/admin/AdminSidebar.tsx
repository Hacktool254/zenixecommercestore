  ...
  return (
    <aside className="flex h-full w-60 shrink-0 flex-col border-r border-[#1e2435] bg-[#0d1117]">
      ...
      <div className="border-t border-[#1e2435] p-3">
        <button className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-[#8b92a5] transition-colors hover:bg-[#1a2035] hover:text-white">
