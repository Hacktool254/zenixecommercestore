      ...
      >
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <a
            ...
            className="whatsapp-pulse flex h-14 w-14 items-center justify-center rounded-full transition-all hover:scale-110 active:scale-95"
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/zenix_electronics?igsh=anVyNDV3aTh5cXEx"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow on Instagram"
            className="instagram-pulse flex h-14 w-14 items-center justify-center rounded-full transition-all hover:scale-110 active:scale-95"
            style={{
          ...
          {/* TikTok */}
          <a
            href="https://www.tiktok.com/@zenixelectronics?_r=1&_t=ZS-95wv7BSxIrR"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Follow on TikTok"
            className="tiktok-pulse flex h-14 w-14 items-center justify-center rounded-full transition-all hover:scale-110 active:scale-95"
            style={{ background: "#010101", border: "1px solid #333" }}
          >
            <svg viewBox="0 0 24 24" fill="white" className="h-6 w-6" aria-hidden="true">
